      ...
      >
        ...
        >
          <h2 className="text-3xl md:text-4xl font-serif font-light text-white mb-2">
            Your Vision, <em className="italic">Our Craft</em>
          </h2>
          <p className="text-sm text-white/70 mb-5 max-w-md mx-auto leading-relaxed">
            Ready to discuss your next project? Let&apos;s collaborate to bring your architectural vision to life.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              to="/contact"
              className="inline-flex items-center gap-2 px-8 py-4 bg-white text-hulma-green rounded-full text-sm font-medium hover:bg-hulma-ghost transition-all whitespace-nowrap cursor-pointer"
            >
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 px-8 py-4 bg-transparent border border-white/30 text-white rounded-full text-sm font-medium hover:bg-white/10 transition-all whitespace-nowrap cursor-pointer"
            >
              <span className="w-4 h-4 flex items-center justify-center">
