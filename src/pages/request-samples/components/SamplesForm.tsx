  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(circle, rgba(180, 201, 204, 0.2) 0%, transparent 70%)',
        }}
      ></div>
          ...
          <div className="lg:col-span-3">
            ...
            >
              <p className="text-[11px] font-semibold uppercase tracking-[2px] text-hulma-brown/60 mb-6">
                01 / Select Materials <span className="text-hulma-orange">*</span>
              </p>

              <p className="text-xs text-hulma-brown/70 mb-4">
                Choose the material types you&apos;d like to sample:
              </p>
                ...
                {materialOptions.map((mat) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex items-center gap-3 px-4 py-3.5 rounded-xl text-sm font-medium transition-all cursor-pointer text-left
                        ${isSelected
                    ...
                    >
                      <span
                        className={`w-5 h-5 flex items-center justify-center rounded-md flex-shrink-0 ${
                          isSelected ? 'bg-white/20' : 'bg-hulma-ghost'
                        }`}
                      >
              ...
              <p className="text-[11px] font-semibold uppercase tracking-[2px] text-hulma-brown/60 mb-4">
                02 / Preferred Colors
              </p>

              <p className="text-xs text-hulma-brown/70 mb-4">
                Optionally select color preferences:
              </p>
              ...
              <div className="space-y-4">
                <div>
                  <label
                    htmlFor="samples-address"
                    className="block text-xs font-medium text-hulma-green mb-1.5"
                  >
                    Street Address{' '}
                    <span className="text-hulma-orange">*</span>
                  </label>
                  <input
                    type="text"
                    id="samples-address"
              ...
              {selectedMaterials.length > 0 && (
                <div className="mt-6 flex items-start gap-3 px-4 py-3 rounded-xl bg-hulma-orange/10 border border-hulma-orange/20">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-hulma-brown/60 mt-0.5">
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              >
                ...
                <div>
                  <label
                    htmlFor="samples-projectType"
                    className="block text-xs font-medium text-hulma-green mb-1.5"
                  >
                    Project Type
                  </label>
                  <select
                    id="samples-projectType"
                    name="projectType"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    maxLength={500}
                    rows={3}
                    placeholder="Specific sizes, finishes, or quantities you need..."
                ...
                {submitStatus === 'success' && (
                  <div className="flex items-center gap-3 px-5 py-4 rounded-xl bg-green-50/80 backdrop-blur-sm border border-green-200/60">
                    ...
                    <p className="text-sm text-green-700">
                      Request submitted! We&apos;ll prepare your samples and
                      reach out soon.
                    </p>
                  </div>
                )}
