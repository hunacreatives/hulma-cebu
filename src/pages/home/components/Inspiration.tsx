      ...
      <div className="max-w-7xl mx-auto">
            ...
            {visibleProjects.map((project, index) => (
              ...
              >
                <div className="relative aspect-[3/2] w-full h-auto overflow-hidden">
                  ...
                  />
                  <div
                    className={`absolute bottom-0 left-0 right-0 p-5 bg-gradient-to-t from-black/60 to-transparent transition-opacity duration-300 ${
        ...
        <div className="flex justify-center mt-12">
          <button
            ...
            className="px-8 py-3 bg-hulma-green text-white text-sm font-medium rounded-full hover:bg-hulma-green/90 transition-all duration-300 shadow-md hover:shadow-lg whitespace-nowrap cursor-pointer"
          >
            View More Projects
          </button>
        </div>
