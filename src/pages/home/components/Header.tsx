...
export default function Header({ forceDark = false }: { forceDark?: boolean }) {
  ...
  const logoSrc = showSolidBg 
    ? 'https://static.readdy.ai/image/08981d36cd0b73cf08022d4d82071d03/305588e21288d5abdb78f9019557dda5.png'
    : 'https://static.readdy.ai/image/08981d36cd0b73cf08022d4d82071d03/f80f0ad8019cef13d6a90e36f07c49f1.png';
          ...
          >
            ...
            <div className="flex-shrink-0">
              ...
              >
                <h1>
                  <img
                    src={mobileMenuOpen ? 'https://static.readdy.ai/image/08981d36cd0b73cf08022d4d82071d03/305588e21288d5abdb78f9019557dda5.png' : logoSrc}
                    alt="HULMA"
